  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative pt-20 pb-28 md:pt-32 md:pb-40 overflow-hidden bg-white">
        <div className="absolute top-0 left-0 right-0 h-[600px] bg-[radial-gradient(circle_at_50%_0%,_var(--tw-gradient-stops))] from-indigo-50 via-white to-white opacity-100 -z-10"></div>
        <div className="absolute top-[10%] left-[5%] w-72 h-72 bg-purple-200/30 rounded-full blur-3xl -z-10 animate-pulse"></div>
        <div className="absolute top-[15%] right-[10%] w-96 h-96 bg-blue-200/30 rounded-full blur-3xl -z-10 animate-pulse delay-700"></div>
        
        <div className="container mx-auto px-4 relative z-10 text-center max-w-5xl">
          <div className="inline-flex items-center gap-2 bg-white border border-slate-200 text-slate-600 px-4 py-1.5 rounded-full text-sm font-bold shadow-sm mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700 hover:border-indigo-200 transition-colors cursor-default">
            <Sparkles className="h-3.5 w-3.5 text-amber-500 fill-amber-500" />
            <span>AI-Powered Copywriter v2.0</span>
          </div>
          
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-extrabold tracking-tight text-slate-900 mb-8 leading-[1.05] animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100">
            Copywriting that <br/>
          ...
          <p className="text-xl md:text-2xl text-slate-600 mb-12 max-w-2xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom-6 duration-700 delay-200 font-light">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-300">
            <Link to="/app/create" className="w-full sm:w-auto px-8 py-4 bg-slate-900 text-white font-bold rounded-2xl shadow-xl shadow-slate-300/50 hover:bg-indigo-600 hover:-translate-y-1 transition-all flex items-center justify-center gap-2 text-lg">
              Start Writing for Free <ArrowRight className="h-5 w-5" />
            </Link>
            <a href="#process" className="w-full sm:w-auto px-8 py-4 bg-white border border-slate-200 text-slate-700 font-bold rounded-2xl hover:bg-slate-50 hover:border-slate-300 transition-all flex items-center justify-center shadow-sm">
              See How It Works
            </a>
          </div>
          ...
          <div className="mt-20 relative mx-auto max-w-5xl animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-500">
             ...
             <div className="bg-white rounded-2xl border border-slate-200 shadow-2xl overflow-hidden p-2">
                <div className="bg-slate-50 border border-slate-100 rounded-xl overflow-hidden relative">
                    {/* Floating labels */}
                    <div className="absolute top-10 left-10 z-20 bg-white shadow-lg border border-slate-100 rounded-lg p-3 flex items-center gap-3 animate-bounce duration-[3000ms]">
                        <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center">
                            <Check className="h-4 w-4 text-green-600" />
                        </div>
                        <div className="text-xs font-bold text-slate-700">Headline Optimized</div>
                    </div>
                    <div className="absolute bottom-20 right-10 z-20 bg-white shadow-lg border border-slate-100 rounded-lg p-3 flex items-center gap-3 animate-bounce duration-[4000ms]">
                        <div className="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center">
                            <Zap className="h-4 w-4 text-indigo-600" />
                        </div>
                        <div className="text-xs font-bold text-slate-700">CTA Generated</div>
                    </div>

                    <div className="h-12 border-b border-slate-100 flex items-center px-4 gap-2 bg-white/50 backdrop-blur">
                        <div className="w-3 h-3 rounded-full bg-red-400"></div>
                        <div className="w-3 h-3 rounded-full bg-amber-400"></div>
                        <div className="w-3 h-3 rounded-full bg-green-400"></div>
                        <div className="ml-4 w-64 h-5 bg-slate-100 rounded-md hidden sm:block opacity-50"></div>
                    </div>
                    <div className="grid grid-cols-12 gap-0 h-[450px]">
                        <div className="col-span-3 border-r border-slate-100 p-6 hidden md:block bg-white/50">
                        ...
                        <div className="col-span-12 md:col-span-9 p-8 md:p-12 flex flex-col items-center justify-center text-center relative overflow-hidden bg-white">
                            <div className="absolute top-0 right-0 p-8 opacity-5">
                                <Sparkles className="w-48 h-48 text-indigo-600" />
                            </div>
                            <div className="space-y-6 max-w-lg z-10 w-full">
                                <div className="h-8 w-32 bg-indigo-50 text-indigo-600 rounded-full mx-auto flex items-center justify-center text-xs font-bold tracking-wider uppercase">New Feature</div>
                                <div className="h-16 w-full bg-slate-900 rounded-xl shadow-lg"></div>
                                <div className="space-y-2">
                                    <div className="h-4 w-full bg-slate-100 rounded"></div>
                                    <div className="h-4 w-5/6 bg-slate-100 rounded mx-auto"></div>
                                </div>
                                <div className="flex justify-center gap-4 pt-4">
                                    <div className="h-12 w-40 bg-indigo-600 rounded-xl shadow-lg shadow-indigo-200"></div>
                                    <div className="h-12 w-32 bg-white border border-slate-200 rounded-xl"></div>
                                </div>
                            </div>
                        </div>
                    </div>
      ...
      <div className="border-y border-slate-100 bg-slate-50/50 py-10">
        <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-10 md:gap-20 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
                <div className="flex items-center gap-2 font-display font-bold text-xl text-slate-800"><div className="w-6 h-6 bg-slate-800 rounded"></div>Acme</div>
                <div className="flex items-center gap-2 font-display font-bold text-xl text-slate-800"><div className="w-6 h-6 rounded-full bg-indigo-600"></div>Starlight</div>
                <div className="flex items-center gap-2 font-display font-bold text-xl text-slate-800"><div className="w-6 h-6 border-2 border-slate-800 rounded"></div>BoltShift</div>
                <div className="flex items-center gap-2 font-display font-bold text-xl text-slate-800"><div className="w-6 h-6 bg-slate-800 rotate-45"></div>Nexus</div>
            </div>
        </div>
      </div>
      ...
      <section id="features" className="py-32 bg-white">
        <div className="container mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-20">
                <div className="inline-block bg-indigo-50 border border-indigo-100 text-indigo-600 px-4 py-1.5 rounded-full text-sm font-bold mb-6">
                    Why LaunchCopy?
                </div>
                <h2 className="text-4xl font-display font-bold text-slate-900 mb-6">Everything you need to launch fast.</h2>
                <p className="text-lg text-slate-600">We don't just generate text. We build structure, persuasion, and flow.</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                {[
                    ...
                    <div key={i} className="group p-8 rounded-3xl border border-slate-100 bg-slate-50/50 hover:bg-white hover:border-indigo-100 hover:shadow-xl hover:shadow-indigo-100/50 transition-all duration-300">
      ...
      {/* Process Section */}
      <section id="process" className="py-32 bg-slate-50 border-y border-slate-200 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div className="order-2 lg:order-1 relative">
                    ...
                    <div className="relative bg-white rounded-2xl p-8 shadow-2xl border border-slate-100">
                         {/* Simulation of the App UI */}
                         <div className="border-b border-slate-100 pb-4 mb-6 flex justify-between items-center">
                            <div className="font-bold text-slate-800">New Project</div>
                            <div className="bg-indigo-100 text-indigo-700 text-xs font-bold px-2 py-1 rounded">Draft</div>
                         </div>
                         <div className="space-y-4">
                            <div>
                                <label className="text-xs font-bold text-slate-500 uppercase">Product Name</label>
                                <div className="p-3 bg-slate-50 rounded-lg text-slate-800 font-medium border border-slate-200 mt-1">SuperCal</div>
                            </div>
                            <div>
                                <label className="text-xs font-bold text-slate-500 uppercase">Problem</label>
                                <div className="p-3 bg-slate-50 rounded-lg text-slate-800 text-sm border border-slate-200 mt-1">Scheduling meetings takes too many emails back and forth.</div>
                            </div>
                            <div className="pt-4">
                                <button className="w-full bg-indigo-600 text-white font-bold py-3 rounded-xl shadow-lg shadow-indigo-200 flex items-center justify-center gap-2">
                ...
                <div className="order-1 lg:order-2">
                    <div className="inline-block bg-white border border-slate-200 text-slate-800 px-4 py-1.5 rounded-full text-sm font-bold mb-8 shadow-sm">
                        How It Works
                    </div>
                    <h2 className="text-4xl md:text-5xl font-display font-bold mb-8 text-slate-900">From idea to <br/>launched in minutes.</h2>
                    <div className="space-y-12">
                        {[
                            ...
                            <div key={i} className="flex gap-6 group">
                                <div className="flex-shrink-0 w-12 h-12 rounded-full bg-white border-2 border-indigo-100 flex items-center justify-center text-indigo-600 font-bold font-mono group-hover:border-indigo-600 group-hover:bg-indigo-600 group-hover:text-white transition-all shadow-sm">
                                    {item.step}
                                </div>
                                <div>
      ...
      <section id="testimonials" className="py-32 bg-white">
        <div className="container mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-20">
                <h2 className="text-4xl font-display font-bold text-slate-900 mb-6">Loved by Builders</h2>
                <p className="text-lg text-slate-600">Join thousands of founders who use LaunchCopy to ship faster.</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
                {[
                    ...
                    <div key={i} className="bg-slate-50 p-8 rounded-3xl border border-slate-100 relative">
                        <Quote className="absolute top-8 right-8 h-8 w-8 text-slate-200 fill-slate-200" />
        ...
        <div className="container mx-auto px-4 max-w-4xl">
            <div className="bg-slate-900 rounded-[3rem] p-12 md:p-24 relative overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-xl text-slate-300 mb-10 max-w-2xl mx-auto">Get your high-converting landing page copy in the next 2 minutes.</p>
                    ...
                    <p className="mt-8 text-sm text-slate-400">No credit card required • Free forever plan</p>
                </div>
            </div>
        </div>
      </section>
